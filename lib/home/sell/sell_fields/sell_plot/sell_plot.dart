...
class _SellPlotState extends State<SellPlot> {
  ...
  void initState() {
    ...
    PurchaseController = TextEditingController(
        text: widget.propertyData == null ? '' : widget.propertyData!['yearPurchased']);
    ...
    areaUnit = widget.propertyData == null
        ? 'Sq.yard'
        : (widget.propertyData!['areaUnit'] ?? 'Sq.yard'); // Default to 'Sq.yard'
    setState(() {});
    super.initState();
  }
  ...
  void createDetails() {
    if (AreaController.text.trim() == '') {
      ...
      propertyData = {
        ...
        'yearPurchased': PurchaseController.text.trim(),
